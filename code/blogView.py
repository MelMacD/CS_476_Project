...
<footer class="footer">
  <div class="container">
    ...
    <a style="position: absolute; left: 50%;" href="https://expressyourself.azurewebsites.net/statistics?blogName={blog}" id="seeStatistics" class="btn btn-default" role="button">Statistics</a>
