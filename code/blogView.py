...
<body>
    ...
    <div id="blogBody">
      <div id="video0" class="draggable resizableAspect video" style="width: 420px; height: 283px; position: absolute; z-index: 0;">
      ...
      <div id="post0" class="border border-dark rounded draggable resizable post" style="width: 422px; height: 225px; position: absolute; z-index: 3; left: 0px; top: 369px;">
      ...
      <div id="image0" class="draggable resizableAspect image" style="width: 279px; height: 384px; position: absolute; z-index: 2; left: 420px; top: 54px;">
